...
const Players = ({ player, setBalance, balance, select, setSelect }) => {
    ...
    <div>
      <div className="border shadow-lg shadow-blue-200  transform transition duration-700  hover:scale-105 hover:z-10 hover:shadow-2xl mx-2 border-gray-300 p-3 rounded-xl">
        ...
        <div className="flex items-center justify-between">
          ...
          <button className="border border-gray-200 px-4 py-1 font-semibold rounded-lg bg-gray-200">
            {player.role}
          </button>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="border border-gray-200 px-3 py-1 rounded-lg font-semibold cursor-pointer hover:bg-blue-600 hover:text-white duration-400"
